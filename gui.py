...
from helpers import db as postgres
from helpers import guihelpers as guihelper
from helpers import frame as frame
...
class Index(tk.Frame):
    def __init__(self, parent, controller):
        ...
        defaultconn = ttk.Button(bottom, text="Use default connection",
                                 command=lambda: guihelper.setdefaultconfig(self))
