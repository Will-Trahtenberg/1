...
class Ui_TeacherFrame(object):
    def setupUi(self, TeacherFrame):
        ...
        self.login_lbl = QtWidgets.QLabel(TeacherFrame)
        self.login_lbl.setObjectName("login_lbl")
        self.lay_login.addWidget(self.login_lbl)
        self.login_edt = QtWidgets.QLineEdit(TeacherFrame)
        ...
        self.fio_lbl = QtWidgets.QLabel(TeacherFrame)
        self.fio_lbl.setObjectName("fio_lbl")
        self.lay_fio.addWidget(self.fio_lbl)
        self.fio_edt = QtWidgets.QLineEdit(TeacherFrame)
        ...
        self.phone_lbl = QtWidgets.QLabel(TeacherFrame)
        self.phone_lbl.setObjectName("phone_lbl")
        self.lay_phone.addWidget(self.phone_lbl)
        self.phone_edt = QtWidgets.QLineEdit(TeacherFrame)
        ...
        self.email_lbl = QtWidgets.QLabel(TeacherFrame)
        self.email_lbl.setObjectName("email_lbl")
        self.lay_email.addWidget(self.email_lbl)
        self.email_edt = QtWidgets.QLineEdit(TeacherFrame)
        ...
        self.comment_lbl = QtWidgets.QLabel(TeacherFrame)
        self.comment_lbl.setObjectName("comment_lbl")
        self.lay_comment.addWidget(self.comment_lbl)
        self.comment_edt = QtWidgets.QTextEdit(TeacherFrame)
    ...
    def retranslateUi(self, TeacherFrame):
        ...
        self.email_lbl.setText(_translate("TeacherFrame", "e-mail"))
